...
class Exporter {
  ...
  Future<bool> toPdfProductSold({List<ProductSoldStat> productSoldStat, DateTime from, DateTime to, mat.BuildContext context}) async {
    ByteData data = await rootBundle.load('assets/fonts/OpenSans-Regular.ttf');
          ...
          return Container(
            child: Column(
              children: <Widget>[
                ...
                Divider(),
                SizedBox(height: 20),
                Align(child: Text("Time range", textAlign: TextAlign.right, style: TextStyle(fontWeight: FontWeight.bold)), alignment: Alignment.centerLeft),
                SizedBox(height: 8),
                ...
                SizedBox(height: 28),
                Align(child: Text("Orders", textAlign: TextAlign.right, style: TextStyle(fontWeight: FontWeight.bold)), alignment: Alignment.centerLeft),
                SizedBox(height: 8),
                ...
                end == productSoldStat.length
                    ? Table(children: [
                        TableRow(children: [Text("Total"), Text("${getSum(productSoldStat)} br", style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold))]),
                      ])
                    : Container(),
