          ...
          child: Form(
            child: Column(
              children: [
                ...
                SizedBox(height: 40,),
                Text("If customer notification is enabled, customers will receive automatic notification via sms when paint order is completed", style: TextStyle(fontSize: 12, color: Colors.black54,),textAlign: TextAlign.justify,)
              ],
            ),
          ),
        )
