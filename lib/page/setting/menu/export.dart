...
class ExportSettingsState extends State<ExportSettings> {
                ...
                children: [
                  OutlineButton(
                      ...
                      onPressed: () async {
                        ...
                        CNotifications.showSnackBar(context, "Successfully exported data", "success", () {}, backgroundColor: Colors.green);
                        setState(() {
                          _exporting = false;
                        });
                      }),
  ...
  static void copyDirectory(Directory source, Directory destination) => source.listSync(recursive: false).forEach((var entity) {
